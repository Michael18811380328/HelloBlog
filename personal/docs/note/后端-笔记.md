...
VNC (Virtual Network Console)是虚拟网络控制台的缩写。它 是一款优秀的[远程控制](https://so.csdn.net/so/search?q=%E8%BF%9C%E7%A8%8B%E6%8E%A7%E5%88%B6&spm=1001.2101.3001.7020)工具软件，可以实现远程控制计算机的功能。
