...
<img width="461" src="https://cloud.seatable.cn/workspace/32/asset/e82c7317-556e-45c4-8b5d-092331cd8977/images/auto-upload/image-1710755391001.png" />

这里设置的意思是：只能加载下面的图片

* 与当前页面相同来源（`'self'`）。
* 数据 URL（`data:`）。
* 域名 `mt0.google.com`、`maps.googleapis.com` 和 `maps.gstatic.com（可能是谷歌地图相关）`
