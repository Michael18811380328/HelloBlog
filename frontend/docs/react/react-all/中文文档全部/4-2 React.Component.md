...
本章节提供了 React class 组件的详细 API 参考。本章节默认你已熟悉基本的 React 概念，例如 [组件 & Props](https://zh-hans.reactjs.org/docs/components-and-props.html)，以及 [State & 生命周期](https://zh-hans.reactjs.org/docs/state-and-lifecycle.html)等。
...
欲了解更多详细信息，请参阅 [*React 16 中的错误处理*](https://zh-hans.reactjs.org/blog/2017/07/26/error-handling-in-react-16.html)。
