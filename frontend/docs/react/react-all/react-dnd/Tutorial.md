...
Now that you've read [the overview](https://react-dnd.github.io/react-dnd/docs/overview), it's adventure time!

![Adventure Time!](https://media.giphy.com/media/132qeyvgJ2Al3i/giphy.gif)

In this tutorial, we're going to build a Chess game with React and React DnD. I'm kidding! Writing a full-blown Chess game is totally out of scope of this tutorial. What we're going to build is a [tiny app with a Chess board and a lonely Knight](https://react-dnd.github.io/react-dnd/examples/tutorial). The Knight will be draggable according to the Chess rules.

If you're comfortable with React already, feel free to skip ahead to the final section: [Adding Drag-and-Drop Interaction](https://react-dnd.github.io/react-dnd/docs/tutorial#adding-drag-and-drop-interaction)
...
- [Setup](https://react-dnd.github.io/react-dnd/docs/tutorial#setup)
- [Building the Game](https://react-dnd.github.io/react-dnd/docs/tutorial#building-the-game)
  - [Identifying the Components](https://react-dnd.github.io/react-dnd/docs/tutorial#identifying-the-components)
  - [Creating the Components](https://react-dnd.github.io/react-dnd/docs/tutorial#creating-the-components)
  - [Adding Game State](https://react-dnd.github.io/react-dnd/docs/tutorial#adding-game-state)
- [Adding Drag-and-Drop Interaction](https://react-dnd.github.io/react-dnd/docs/tutorial#adding-drag-and-drop-interaction)
  - [Setting up the Drag-and-Drop Context](https://react-dnd.github.io/react-dnd/docs/tutorial#setting-up-the-drag-and-drop-context)
  - [Define Drag Types](https://react-dnd.github.io/react-dnd/docs/tutorial#define-drag-types)
  - [Make the Knight Draggable](https://react-dnd.github.io/react-dnd/docs/tutorial#make-the-knight-draggable)
  - [Make the Board Squares Droppable](https://react-dnd.github.io/react-dnd/docs/tutorial#make-the-board-squares-droppable)
  - [Add a Drag Preview Image](https://react-dnd.github.io/react-dnd/docs/tutorial#add-a-drag-preview-image)
- [Concluding Words](https://react-dnd.github.io/react-dnd/docs/tutorial#concluding-words)
...
The app we're going to build is [available as an example on this website](https://react-dnd.github.io/react-dnd/examples/tutorial).
...
![Screenshot](http://i.imgur.com/NktjTMn.png)
...
![Screenshot](http://i.imgur.com/jvgv6DV.png)
...
![Screenshot](http://i.imgur.com/Br30DLg.png)
...
![Screenshot](http://i.imgur.com/RsQDI4Y.png)
...
![Screenshot](http://i.imgur.com/0fNBn5a.png)
...
![Screenshot](https://s3.amazonaws.com/f.cl.ly/items/1K0s0n0r0C0e2P2N2D1d/Screen%20Recording%202015-05-15%20at%2012.06%20pm.gif)
...
The last missing piece right now is the Chess rule check. The `Knight`can't just move to an arbitrary square, it is only allowed to make [L-shaped moves](http://en.wikipedia.org/wiki/Knight_(chess)#Movement). I'm adding a `canMoveKnight(toX, toY)`function to the `Game`and changing the initial position to A2 to match the Chess rules:
...
![Screenshot](https://s3.amazonaws.com/f.cl.ly/items/1F371u301l1H2X3o0g1h/Screen%20Recording%202015-05-15%20at%2012.08%20pm.gif)
...
The first thing we need to set up in our app is the [`DndProvider`](https://react-dnd.github.io/react-dnd/docs/api/dnd-provider). This should be mounted near the top of our application. We need this to specify that we're going to use the [HTML5Backend](https://react-dnd.github.io/react-dnd/docs/backends/html5).
...
The [`useDrag`](https://react-dnd.github.io/react-dnd/docs/api/use-drag)hook accepts a specification object. In this object, `item.type`is set to the constant we just defined, so now we need to write a collecting function.
...
![Screenshot](https://s3.amazonaws.com/f.cl.ly/items/3L1d0C203C0s1r1H2H0m/Screen%20Recording%202015-05-15%20at%2001.11%20pm.gif)
...
Let's now wrap the `BoardSquare`with a [`useDrop`](https://react-dnd.github.io/react-dnd/docs/api/use-drop)hook. I'm going to write a drop target specification that only handles the `drop`event:
...
![Screenshot](https://s3.amazonaws.com/f.cl.ly/items/2U43301g421U3I2X2p0P/Screen%20Recording%202015-05-15%20at%2001.55%20pm.gif)
...
![Screenshot](https://s3.amazonaws.com/f.cl.ly/items/0X3c342g0i3u100p1o18/Screen%20Recording%202015-05-15%20at%2002.05%20pm.gif)
...
![Screenshot](https://s3.amazonaws.com/f.cl.ly/items/1F2g2F0D470X0d0k2A1U/Screen%20Recording%202015-05-15%20at%2002.22%20pm.gif)

Now go and [play with it](https://react-dnd.github.io/react-dnd/examples/tutorial)!