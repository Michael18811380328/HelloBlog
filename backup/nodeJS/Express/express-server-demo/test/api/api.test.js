...
describe("TEST API USED WITHIN A DTABLE", () => {
  ...
  beforeAll(() => {
    return testHelperAPI
      .getDtableWebAuthToken(TEST_USER_EMAIL, TEST_USER_PASSWORD)
      .then((res) => {
        console.log(res.data);
        expect(res.statusText).toBe("OK");
        authToken = res.data.token;
        return testHelperAPI.createDTable(
          TEST_DTABLE_NAME,
          TEST_USER_EMAIL,
          authToken
        );
      ...
      .then((res) => {
        ...
        return testHelperAPI.getAccessToken(
          workspaceId,
          TEST_DTABLE_NAME,
          authToken
        );
      ...
      .then((res) => {
        ...
        return testHelperAPI.getDtableWebAuthToken(
          TEST_READ_ONLY_USER_EMAIL,
          TEST_READ_ONLY_USER_PASSWORD
        );
      })
      .then((res) => {
        ...
        return testHelperAPI.shareDTable(
          workspaceId,
          TEST_DTABLE_NAME,
          TEST_READ_ONLY_USER_EMAIL,
          "r",
  ...
  afterAll(() => {
    return testHelperAPI
      .deleteDTable(workspaceId, TEST_DTABLE_NAME, authToken)
      .then((res) => {});
  });

  test("test get dtable", () => {
    return request(app)
      .get("/dtables/" + dtableUUID + "/")
  ...
  test("test create row", () => {
    ...
    // normal create row
    return request(app)
      .post("/api/v1/dtables/" + dtableUUID + "/rows/")
      ...
      .then((res) => {
        ...
        return request(app)
          .post("/api/v1/dtables/" + dtableUUID + "/rows/")
          .send(body)
          .set("Authorization", "Token " + readDTableAccessToken);
      })
      .then((res) => {
  ...
  test("test update row", () => {
    ...
    return request(app)
      ...
      .then((res) => {
        ...
        let putBody = Object.assign({}, body, {
          row_id: row_id,
          Name: "I am updated",
        });
        // normal update
        return request(app)
          .put("/api/v1/dtables/" + dtableUUID + "/rows/")
          .send(putBody)
          .set("Authorization", "Token " + dtableAccessToken);
      })
      .then((res) => {
        ...
        let putBody = Object.assign({}, body, {
          row_id: row_id,
          Name: "I am updated by read-only",
        });
        // read-only update
        return request(app)
          .put("/api/v1/dtables/" + dtableUUID + "/rows/")
  ...
  test("test delete row", () => {
    ...
    return request(app)
      ...
      .then((res) => {
        ...
        return request(app)
          .delete("/api/v1/dtables/" + dtableUUID + "/rows/")
          .send(deleteBody)
          .set("Authorization", "Token " + readDTableAccessToken);
      })
      .then((res) => {
