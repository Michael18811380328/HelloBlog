...
font-family 可以选择多个字体，逗号隔开；不同电脑安装字体不一样，英文字体单个单词不用加引号，其他情况都需要加引号，尽量使用默认字体便于浏览器兼容，使用汉字部分系统 XP 不能识别，最好使用英文或者 unicode 编码字体-查找代码

字体使用斜杠\其他标签使用反斜杠/

使用 i 或者 em 标签也可以表示倾斜，属性 normal 或 italic 通常情况下可以让粗体变成非粗体
...
选择器还有一点模糊（子代后代，兄弟等等）JQ 选择器和 CSS 选择器的关系。
