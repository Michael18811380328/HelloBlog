...
浏览器打开`demos/jsx-demo/index.html`，完成练习。
...
打开`demos/react-component-demo/index2.html`，完成练习。
...
浏览器打开`demos/react-component-demo/index4.html`，完成练习。
...
打开`demos/react-lifecycle-demo/index.html`，完成练习。
...
进入`demos/mobx-demo`目录，，理解 MobX 框架。
...
进入`demos/redux-demo`目录，理解 Redux 框架。
